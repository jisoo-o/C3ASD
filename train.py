...
def main():
    ...
    parser.add_argument('--batchSize',    type=int,   default=1000,  help='Dynamic batch size, default is 1000 frames')
    parser.add_argument('--nDataLoaderThread', type=int, default=64,  help='Number of loader threads')
    parser.add_argument('--lambda_inter', type=float, default=0.01, help='Weight for inter-modality consistency loss')
    parser.add_argument('--lambda_intra_audio', type=float, default=0.001, help='Weight for intra-modality consistency loss (audio)')
    parser.add_argument('--lambda_intra_visual', type=float, default=0.001, help='Weight for intra-modality consistency loss (visual)')
    parser.add_argument('--lambda_pred', type=float, default=0.01, help='Weight for prediction-level consistency loss')
    parser.add_argument('--intra_temperature', type=float, default=0.07, help='Temperature for intra-modality consistency loss')
    # Data path
    ...
    if args.evaluation == True:
        ...
        print("Model %s loaded from previous state!"%('weight/pretrain_AVA.model'))
